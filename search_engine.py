...
_ZH_EN_DICT = {
    # ========== 材料科学 ==========
    "二维": "2D", "富勒烯": "fullerene", "电催化": "electrocatalysis",
    "石墨烯": "graphene", "纳米": "nano", "纳米材料": "nanomaterials",
    "催化剂": "catalyst", "催化": "catalysis", "光催化": "photocatalysis",
    "电化学": "electrochemistry", "电池": "battery", "锂离子": "lithium-ion",
    "太阳能电池": "solar cell", "钙钛矿": "perovskite",
    "纳米粒子": "nanoparticles", "纳米线": "nanowire", "纳米管": "nanotube",
    "碳纳米管": "carbon nanotube", "量子点": "quantum dot",
    "薄膜": "thin film", "涂层": "coating", "合金": "alloy",
    "复合材料": "composite", "陶瓷": "ceramic", "聚合物": "polymer",
    "水凝胶": "hydrogel", "生物材料": "biomaterial",
    # 材料科学补充
    "纳米片": "nanosheet", "纳米棒": "nanorod", "纳米花": "nanoflower",
    "纳米球": "nanosphere", "纳米晶": "nanocrystal", "纳米纤维": "nanofiber",
    "量子阱": "quantum well", "量子线": "quantum wire",
    "MXene": "MXene", "黑磷": "black phosphorus",
    "过渡金属硫化物": "transition metal dichalcogenide",
    "二硫化钼": "molybdenum disulfide", "二硫化钨": "tungsten disulfide",
    "氮化硼": "boron nitride", "氮化镓": "gallium nitride",
    "碳化硅": "silicon carbide", "碳化硼": "boron carbide",
    "氧化锌": "zinc oxide", "氧化钛": "titanium dioxide",
    "氧化铁": "iron oxide", "氧化铝": "alumina", "氧化铈": "ceria",
    "氮化硅": "silicon nitride", "氮化铝": "aluminum nitride",
    "钛合金": "titanium alloy", "铝合金": "aluminum alloy",
    "镁合金": "magnesium alloy", "镍基合金": "nickel-based alloy",
    "高温合金": "superalloy", "形状记忆合金": "shape memory alloy",
    "非晶合金": "amorphous alloy", "高熵合金": "high-entropy alloy",
    "碳纤维": "carbon fiber", "玻璃纤维": "glass fiber",
    "芳纶": "aramid fiber", "碳化硅纤维": "silicon carbide fiber",
    "纤维增强": "fiber reinforced", "层板": "laminate",
    "压电材料": "piezoelectric material", "热电材料": "thermoelectric material",
    "铁电材料": "ferroelectric material", "磁性材料": "magnetic material",
    "超导材料": "superconducting material", "发光材料": "luminescent material",
    "光电材料": "optoelectronic material", "储能材料": "energy storage material",
    "阳极氧化": "anodizing", "电镀": "electroplating",
    "化学气相沉积": "chemical vapor deposition",
    "物理气相沉积": "physical vapor deposition",
    "原子层沉积": "atomic layer deposition",
    "溅射": "sputtering", "分子束外延": "molecular beam epitaxy",
    "溶胶凝胶": "sol-gel", "水热合成": "hydrothermal synthesis",
    "溶剂热": "solvothermal", "共沉淀": "co-precipitation",
    "静电纺丝": "electrospinning", "3D打印": "3D printing",
    "X射线衍射": "X-ray diffraction", "扫描电镜": "scanning electron microscope",
    "透射电镜": "transmission electron microscope",
    "原子力显微镜": "atomic force microscope",
    "X射线光电子能谱": "X-ray photoelectron spectroscopy",
    "拉曼光谱": "Raman spectroscopy", "红外光谱": "infrared spectroscopy",
    "热重分析": "thermogravimetric analysis",
    "差示扫描量热法": "differential scanning calorimetry",
    "比表面积": "specific surface area", "孔隙率": "porosity",
    "吸附": "adsorption", "脱附": "desorption",
    "接触角": "contact angle", "表面能": "surface energy",
    "硬度": "hardness", "韧性": "toughness", "强度": "strength",
    "延展性": "ductility", "弹性模量": "elastic modulus",
    "疲劳": "fatigue", "断裂": "fracture", "蠕变": "creep",
    "腐蚀": "corrosion", "抗氧化": "antioxidant",
    "润滑": "lubrication", "摩擦": "friction", "磨损": "wear",

    # ========== 化学 ==========
    "有机": "organic", "无机": "inorganic", "分析化学": "analytical chemistry",
    "合成": "synthesis", "反应": "reaction", "分子": "molecule",
    "配位": "coordination", "金属有机框架": "metal-organic framework",
    "MOF": "MOF", "共价有机框架": "covalent organic framework",
    "COF": "COF",
    # 有机化学
    "官能团": "functional group", "反应机理": "reaction mechanism",
    "加成反应": "addition reaction", "取代反应": "substitution reaction",
    "消除反应": "elimination reaction", "重排反应": "rearrangement reaction",
    "缩合反应": "condensation reaction", "氧化反应": "oxidation reaction",
    "还原反应": "reduction reaction", "偶联反应": "coupling reaction",
    "手性": "chirality", "立体化学": "stereochemistry",
    "对映体": "enantiomer", "非对映体": "diastereomer",
    "共轭": "conjugation", "芳香性": "aromaticity",
    "杂环": "heterocycle", "酰胺": "amide", "酯": "ester",
    "醚": "ether", "醛": "aldehyde", "酮": "ketone",
    "羧酸": "carboxylic acid", "胺": "amine", "醇": "alcohol",
    "腈": "nitrile", "硝基": "nitro group", "磺酸基": "sulfonic acid group",
    # 无机化学
    "配位化合物": "coordination compound", "配体": "ligand",
    "中心原子": "central atom", "配位数": "coordination number",
    "八面体": "octahedral", "四面体": "tetrahedral",
    "金属有机化学": "organometallic chemistry", "簇合物": "cluster compound",
    "氧化态": "oxidation state", "晶体场理论": "crystal field theory",
    ...
    "伏安法": "voltammetry", "循环伏安法": "cyclic voltammetry",
    # 物理化学
    "化学平衡": "chemical equilibrium", "反应速率": "reaction rate",
    "活化能": "activation energy", "过渡态": "transition state",
    "反应坐标": "reaction coordinate", "表面化学": "surface chemistry",
    "多相催化": "heterogeneous catalysis", "均相催化": "homogeneous catalysis",
    "吉布斯自由能": "Gibbs free energy", "化学势": "chemical potential",
    "相变": "phase transition", "胶体": "colloid",
    "界面": "interface", "表面张力": "surface tension",
    # 高分子化学
    "聚合反应": "polymerization",
    "加聚反应": "addition polymerization",
    "缩聚反应": "condensation polymerization",
    "共聚物": "copolymer", "嵌段共聚物": "block copolymer",
    "交联": "crosslinking", "引发剂": "initiator",
    "单体": "monomer", "低聚物": "oligomer",
    "玻璃化转变温度": "glass transition temperature",
    "结晶度": "crystallinity", "热塑性": "thermoplastic",
    "热固性": "thermosetting", "弹性体": "elastomer",
    # 药物化学
    "药效团": "pharmacophore", "构效关系": "structure-activity relationship",
    "药代动力学": "pharmacokinetics", "药效学": "pharmacodynamics",
    "生物利用度": "bioavailability", "半衰期": "half-life",
    "血脑屏障": "blood-brain barrier", "受体": "receptor",
    "酶抑制剂": "enzyme inhibitor", "药物设计": "drug design",
    "先导化合物": "lead compound", "药物筛选": "drug screening",
    "细胞毒性": "cytotoxicity", "抗菌活性": "antimicrobial activity",
    ...
    "生物降解": "biodegradation", "光降解": "photodegradation",
    "污水处理": "wastewater treatment", "微塑料": "microplastic",
    # 生物化学
    "氨基酸": "amino acid", "核苷酸": "nucleotide",
    "蛋白质折叠": "protein folding", "酶催化": "enzymatic catalysis",
    "辅酶": "coenzyme", "底物": "substrate",
    "代谢途径": "metabolic pathway", "信号转导": "signal transduction",
    "转录因子": "transcription factor", "表观遗传": "epigenetics",
    "基因表达": "gene expression", "细胞凋亡": "apoptosis",
    "细胞自噬": "autophagy",
    # 计算化学
    "密度泛函理论": "density functional theory",
    "分子动力学": "molecular dynamics",
    "蒙特卡洛模拟": "Monte Carlo simulation",
    "从头算": "ab initio", "基组": "basis set",
    "几何优化": "geometry optimization",
    "势能面": "potential energy surface",
    "分子轨道": "molecular orbital",
    "前线轨道理论": "frontier molecular orbital theory",
    "偶极矩": "dipole moment", "极化率": "polarizability",
    "溶剂化模型": "solvation model", "构象": "conformation",
    "活性位点": "active site",

    # ========== 生物医学 ==========
    "基因": "gene", "蛋白质": "protein", "细胞": "cell",
    "肿瘤": "tumor", "癌症": "cancer", "免疫": "immunity",
    "疫苗": "vaccine", "抗体": "antibody", "基因编辑": "gene editing",
    "CRISPR": "CRISPR", "干细胞": "stem cell", "基因组": "genome",
    "蛋白质组": "proteomics", "代谢组": "metabolomics",
    "生物信息学": "bioinformatics",
    # 分子生物学
    "转录": "transcription", "翻译": "translation",
    "信使RNA": "messenger RNA", "核糖体RNA": "ribosomal RNA",
    "转运RNA": "transfer RNA", "DNA甲基化": "DNA methylation",
    "组蛋白": "histone", "染色质": "chromatin",
    "启动子": "promoter", "增强子": "enhancer",
    "外显子": "exon", "内含子": "intron", "剪接": "splicing",
    "翻译后修饰": "post-translational modification",
    "DNA复制": "DNA replication", "RNA干扰": "RNA interference",
    "小干扰RNA": "small interfering RNA", "微小RNA": "microRNA",
    "长链非编码RNA": "long non-coding RNA",
    "核酸酶": "nuclease", "聚合酶": "polymerase",
    "连接酶": "ligase", "限制性内切酶": "restriction endonuclease",
    # 细胞生物学
    "线粒体": "mitochondria", "内质网": "endoplasmic reticulum",
    "高尔基体": "Golgi apparatus", "溶酶体": "lysosome",
    "核糖体": "ribosome", "细胞膜": "cell membrane",
    "细胞核": "nucleus", "细胞周期": "cell cycle",
    "细胞分裂": "cell division", "有丝分裂": "mitosis",
    "减数分裂": "meiosis", "细胞迁移": "cell migration",
    "细胞分化": "cell differentiation", "细胞增殖": "cell proliferation",
    "细胞粘附": "cell adhesion", "细胞骨架": "cytoskeleton",
    "微管": "microtubule", "微丝": "microfilament",
    "中间丝": "intermediate filament", "中心体": "centrosome",
    "内吞": "endocytosis", "外排": "exocytosis",
    "细胞外基质": "extracellular matrix",
    # 免疫学
    "T细胞": "T cell", "B细胞": "B cell",
    "自然杀伤细胞": "natural killer cell", "巨噬细胞": "macrophage",
    "树突状细胞": "dendritic cell", "中性粒细胞": "neutrophil",
    "淋巴细胞": "lymphocyte", "细胞因子": "cytokine",
    "干扰素": "interferon", "白细胞介素": "interleukin",
    "肿瘤坏死因子": "tumor necrosis factor",
    "主要组织相容性复合体": "major histocompatibility complex",
    "免疫检查点": "immune checkpoint", "炎症": "inflammation",
    "补体系统": "complement system", "自身免疫": "autoimmunity",
    "免疫缺陷": "immunodeficiency", "过敏反应": "hypersensitivity",
    "抗原": "antigen", "细胞毒性": "cytotoxicity",
    "吞噬作用": "phagocytosis", "适应性免疫": "adaptive immunity",
    "先天性免疫": "innate immunity",
    # 神经科学
    "神经元": "neuron", "突触": "synapse", "神经递质": "neurotransmitter",
    "多巴胺": "dopamine", "血清素": "serotonin",
    "乙酰胆碱": "acetylcholine", "谷氨酸": "glutamate",
    "神经胶质细胞": "glial cell", "星形胶质细胞": "astrocyte",
    "少突胶质细胞": "oligodendrocyte", "小胶质细胞": "microglia",
    "髓鞘": "myelin", "轴突": "axon", "树突": "dendrite",
    "神经可塑性": "neuroplasticity", "海马体": "hippocampus",
    "大脑皮层": "cerebral cortex", "下丘脑": "hypothalamus",
    "垂体": "pituitary gland", "脑干": "brainstem",
    "神经退行性疾病": "neurodegenerative disease",
    "帕金森病": "Parkinson's disease", "阿尔茨海默病": "Alzheimer's disease",
    "突触可塑性": "synaptic plasticity", "神经发生": "neurogenesis",
    # 肿瘤学
    "转移": "metastasis", "原发性肿瘤": "primary tumor",
    "良性肿瘤": "benign tumor", "恶性肿瘤": "malignant tumor",
    "腺癌": "adenocarcinoma", "鳞状细胞癌": "squamous cell carcinoma",
    "淋巴瘤": "lymphoma", "白血病": "leukemia", "黑色素瘤": "melanoma",
    "胶质瘤": "glioma", "乳腺癌": "breast cancer", "肺癌": "lung cancer",
    "肝癌": "liver cancer", "胃癌": "gastric cancer",
    "结直肠癌": "colorectal cancer", "前列腺癌": "prostate cancer",
    "卵巢癌": "ovarian cancer", "胰腺癌": "pancreatic cancer",
    "化疗": "chemotherapy", "放疗": "radiation therapy",
    "靶向治疗": "targeted therapy", "免疫治疗": "immunotherapy",
    "激素治疗": "hormonal therapy", "生物标志物": "biomarker",
    "肿瘤微环境": "tumor microenvironment",
    "细胞周期阻滞": "cell cycle arrest", "耐药性": "drug resistance",
    "血管生成": "angiogenesis",
    "上皮间质转化": "epithelial-mesenchymal transition",
    # 心血管医学
    "动脉粥样硬化": "atherosclerosis", "心肌梗死": "myocardial infarction",
    "心力衰竭": "heart failure", "高血压": "hypertension",
    "心律失常": "arrhythmia", "冠心病": "coronary artery disease",
    "血栓": "thrombosis", "栓塞": "embolism", "心肌病": "cardiomyopathy",
    # 微生物学
    "细菌": "bacteria", "病毒": "virus", "真菌": "fungus",
    "微生物组": "microbiome", "抗生素": "antibiotic",
    "抗病毒": "antiviral", "感染": "infection", "脓毒症": "sepsis",
    "肺炎": "pneumonia", "结核病": "tuberculosis",
    "疟疾": "malaria", "流感": "influenza", "冠状病毒": "coronavirus",
    "肠道菌群": "gut flora", "抗微生物耐药": "antimicrobial resistance",
    # 药理学
    "药效动力学": "pharmacodynamics", "药物靶点": "drug target",
    "受体激动剂": "receptor agonist", "受体拮抗剂": "receptor antagonist",
    "抑制剂": "inhibitor", "激动剂": "agonist", "拮抗剂": "antagonist",
    "不良反应": "adverse reaction", "药物相互作用": "drug interaction",
    ...
    "横断面研究": "cross-sectional study", "荟萃分析": "meta-analysis",
    "系统评价": "systematic review", "循证医学": "evidence-based medicine",
    "个体化医疗": "precision medicine", "基因检测": "genetic testing",
    "核磁共振成像": "magnetic resonance imaging",
    "计算机断层扫描": "computed tomography", "超声": "ultrasound",
    "病理": "pathology", "活检": "biopsy", "手术": "surgery",
    "康复": "rehabilitation",
    # 生物信息学
    "基因组学": "genomics", "转录组学": "transcriptomics",
    "单细胞测序": "single-cell sequencing",
    "高通量测序": "high-throughput sequencing",
    "下一代测序": "next-generation sequencing", "RNA测序": "RNA sequencing",
    "基因本体": "gene ontology", "通路分析": "pathway analysis",
    "分子对接": "molecular docking", "结构预测": "structure prediction",
    "同源建模": "homology modeling", "序列比对": "sequence alignment",
    "系统发育": "phylogenetics", "进化树": "phylogenetic tree",

    # ========== 物理学与天文学 ==========
    "超导": "superconductivity", "量子": "quantum", "光学": "optics",
    "激光": "laser", "光谱": "spectroscopy", "磁性": "magnetism",
    "半导体": "semiconductor", "拓扑": "topological",
    # 凝聚态物理
    "拓扑绝缘体": "topological insulator", "量子霍尔效应": "quantum Hall effect",
    "自旋电子学": "spintronics", "超流体": "superfluid",
    "玻色-爱因斯坦凝聚": "Bose-Einstein condensate", "磁共振": "magnetic resonance",
    "铁电体": "ferroelectric", "反铁磁": "antiferromagnetic",
    "莫特绝缘体": "Mott insulator", "外尔半金属": "Weyl semimetal",
    "凝聚态": "condensed matter",
    # 光学
    "非线性光学": "nonlinear optics", "超快光学": "ultrafast optics",
    "光子学": "photonics", "等离激元": "plasmonics",
    "光子晶体": "photonic crystal", "超构材料": "metamaterial",
    "受激拉曼散射": "stimulated Raman scattering",
    # [新增] 光镊和光学操纵
    "光镊": "optical tweezers", "光阱": "optical trap",
    "光捕获": "optical trapping", "光学操纵": "optical manipulation",
    "光扭矩": "optical torque", "光力": "optical force",
    "梯度力": "gradient force", "散射力": "scattering force",
    # [新增] 激光相关
    "飞秒激光": "femtosecond laser", "皮秒激光": "picosecond laser",
    "纳秒激光": "nanosecond laser", "连续激光": "continuous wave laser",
    "脉冲激光": "pulsed laser", "超快激光": "ultrafast laser",
    # [新增] 等离激元和表面增强
    "表面等离激元": "surface plasmon", "等离激元共振": "plasmon resonance",
    "表面增强拉曼散射": "surface-enhanced Raman scattering",
    "局域表面等离激元": "localized surface plasmon",
    # [新增] 近场光学和太赫兹
    "近场光学": "near-field optics", "远场光学": "far-field optics",
    "太赫兹": "terahertz", "太赫兹辐射": "terahertz radiation",
    "二次谐波": "second harmonic generation",
    "光学参量振荡": "optical parametric oscillation",
    # 粒子物理
    "夸克": "quark", "轻子": "lepton", "玻色子": "boson",
    "费米子": "fermion", "标准模型": "standard model",
    "希格斯玻色子": "Higgs boson", "中微子": "neutrino",
    "正电子": "positron", "反物质": "antimatter",
    # 核物理
    "核裂变": "nuclear fission", "核聚变": "nuclear fusion",
    "放射性衰变": "radioactive decay", "α衰变": "alpha decay",
    "β衰变": "beta decay", "γ射线": "gamma ray",
    # 天体物理
    "黑洞": "black hole", "中子星": "neutron star", "白矮星": "white dwarf",
    "脉冲星": "pulsar", "类星体": "quasar", "星系": "galaxy",
    "暗物质": "dark matter", "暗能量": "dark energy",
    "引力波": "gravitational wave", "宇宙微波背景辐射": "cosmic microwave background",
    "恒星演化": "stellar evolution", "超新星": "supernova",
    "吸积盘": "accretion disk", "红移": "redshift",
    "视界": "event horizon", "霍金辐射": "Hawking radiation",
    # 量子物理
    "量子纠缠": "quantum entanglement", "量子计算": "quantum computing",
    "量子通信": "quantum communication", "量子比特": "qubit",
    "量子退相干": "quantum decoherence", "贝尔不等式": "Bell inequality",
    "量子隐形传态": "quantum teleportation", "薛定谔方程": "Schrödinger equation",
    "波函数": "wave function", "海森堡不确定性原理": "Heisenberg uncertainty principle",
    "路径积分": "path integral", "量子场论": "quantum field theory",
    # 等离子体物理
    "等离子体": "plasma", "托卡马克": "tokamak",
    "惯性约束聚变": "inertial confinement fusion",
    "德拜长度": "Debye length",
    # 声学
    "声子": "phonon", "声学超材料": "acoustic metamaterial",
    "声发射": "acoustic emission", "声悬浮": "acoustic levitation",
    # 热力学
    "熵": "entropy", "焓": "enthalpy", "临界点": "critical point",
    "玻尔兹曼分布": "Boltzmann distribution", "伊辛模型": "Ising model",
    "自由能": "free energy", "比热容": "specific heat capacity",
    "热导率": "thermal conductivity", "热辐射": "thermal radiation",
    "黑体辐射": "blackbody radiation",
    # 流体力学
    "湍流": "turbulence", "纳维-斯托克斯方程": "Navier-Stokes equation",
    "边界层": "boundary layer", "涡旋": "vortex",
    ...
    # 机械工程
    "有限元分析": "finite element analysis", "流体力学": "fluid mechanics",
    "热传导": "heat transfer", "材料力学": "mechanics of materials",
    "焊接": "welding", "切削加工": "machining",
    "增材制造": "additive manufacturing", "数控加工": "CNC machining",
    "铸造": "casting",
    # 电气工程
    "电机": "electric motor", "电力系统": "power system",
    "电磁场": "electromagnetic field", "变压器": "transformer",
    "电力电子": "power electronics", "变频器": "inverter",
    "绝缘": "insulation", "谐波": "harmonics",
    # 电子工程
    "集成电路": "integrated circuit", "场效应晶体管": "field-effect transistor",
    "MOSFET": "MOSFET", "印制电路板": "printed circuit board",
    "可编程逻辑器件": "programmable logic device",
    "射频": "radio frequency", "天线": "antenna", "信号处理": "signal processing",
    # 计算机科学
    "算法": "algorithm", "数据结构": "data structure",
    "操作系统": "operating system", "分布式系统": "distributed system",
    ...
    "注意力机制": "attention mechanism", "语义分割": "semantic segmentation",
    "目标检测": "object detection", "语义分析": "semantic analysis",
    "大语言模型": "large language model", "变换器": "transformer",
    "预训练": "pre-training", "微调": "fine-tuning",
    "提示工程": "prompt engineering", "检索增强生成": "retrieval-augmented generation",
    # 机器人学
    "运动学": "kinematics", "控制器": "controller", "传感器": "sensor",
    "执行器": "actuator", "路径规划": "path planning",
    "同时定位与建图": "simultaneous localization and mapping",
    # 土木工程
    "岩土工程": "geotechnical engineering", "混凝土": "concrete",
    "结构工程": "structural engineering",
    # 化学工程
    "蒸馏": "distillation", "传质": "mass transfer",
    "反应工程": "reaction engineering", "分离工程": "separation engineering",
    # 航空航天
    "空气动力学": "aerodynamics", "推进系统": "propulsion system",
    "飞行控制": "flight control", "涡轮": "turbine",
    "无人机": "unmanned aerial vehicle",
    # 生物医学工程
    "生物力学": "biomechanics", "医学影像": "medical imaging",
    "康复工程": "rehabilitation engineering", "组织工程": "tissue engineering",
    # 能源
    "燃料电池": "fuel cell", "风力发电": "wind power", "生物质能": "bioenergy",
    "储能": "energy storage", "超级电容器": "supercapacitor",
    "锂硫电池": "lithium-sulfur battery", "钠离子电池": "sodium-ion battery",
    "锌空气电池": "zinc-air battery",

    # ========== 环境科学与地球科学 ==========
    "环境": "environment", "污染": "pollution", "气候": "climate",
    "碳排放": "carbon emission", "可持续": "sustainable",
    "可再生能源": "renewable energy", "氢能": "hydrogen energy",
    # 大气污染
    "大气污染": "air pollution", "颗粒物": "particulate matter",
    "PM2.5": "PM2.5", "臭氧": "ozone", "二氧化硫": "sulfur dioxide",
    "氮氧化物": "nitrogen oxides", "挥发性有机物": "volatile organic compounds",
    "酸雨": "acid rain", "光化学烟雾": "photochemical smog",
    # 水污染
    "水污染": "water pollution", "废水处理": "wastewater treatment",
    "富营养化": "eutrophication", "化学需氧量": "chemical oxygen demand",
    "生化需氧量": "biochemical oxygen demand",
    "重金属": "heavy metals", "地下水": "groundwater", "地表水": "surface water",
    "膜分离": "membrane separation",
    # 土壤污染
    "土壤污染": "soil pollution", "土壤修复": "soil remediation",
    "有机污染物": "organic pollutants", "农药残留": "pesticide residue",
    "生物修复": "bioremediation", "植物修复": "phytoremediation",
    # 固废处理
    "固体废物": "solid waste", "垃圾填埋": "landfill",
    "焚烧": "incineration", "回收利用": "recycling",
    "危险废物": "hazardous waste", "电子废弃物": "e-waste",
    "塑料污染": "plastic pollution", "微塑料": "microplastics",
    # 气候变化
    "温室效应": "greenhouse effect", "温室气体": "greenhouse gas",
    "全球变暖": "global warming", "碳循环": "carbon cycle",
    "碳足迹": "carbon footprint", "碳中和": "carbon neutrality",
    "碳达峰": "carbon peak", "净零排放": "net zero emissions",
    "极端天气": "extreme weather", "气候变化": "climate change",
    "全球气候模型": "global climate model", "海平面上升": "sea level rise",
    "冰川消融": "glacier retreat", "冻土融化": "permafrost thawing",
    "厄尔尼诺": "El Nino", "干旱": "drought", "洪涝": "flooding",
    # 生态学
    "生态系统": "ecosystem", "生物多样性": "biodiversity",
    "种群": "population", "群落": "community",
    "食物链": "food chain", "食物网": "food web",
    "生态修复": "ecological restoration", "物种灭绝": "species extinction",
    "入侵物种": "invasive species", "生物富集": "bioaccumulation",
    "保护生物学": "conservation biology",
    # 地质学
    "岩石": "rock", "矿物": "mineral", "地震": "earthquake",
    "火山": "volcano", "板块构造": "plate tectonics",
    "沉积物": "sediment", "岩浆": "magma", "地壳": "crust",
    "地幔": "mantle", "断层": "fault", "褶皱": "fold",
    "侵蚀": "erosion", "风化": "weathering", "变质作用": "metamorphism",
    "古生物学": "paleontology", "地层学": "stratigraphy",
    # 海洋学
    "海洋": "ocean", "洋流": "ocean current",
    "海洋酸化": "ocean acidification", "深海": "deep sea",
    "珊瑚礁": "coral reef", "潮汐": "tide", "海啸": "tsunami",
    "海水淡化": "desalination",
    # 水文学
    "径流": "runoff", "水循环": "water cycle", "流域": "watershed",
    "水文模型": "hydrological model", "蒸散发": "evapotranspiration",
    "降水": "precipitation", "地下水位": "water table",
    "含水层": "aquifer", "水土流失": "soil erosion",
    # 大气科学
    "气象": "meteorology", "大气化学": "atmospheric chemistry",
    "大气层": "atmosphere", "对流层": "troposphere",
    "平流层": "stratosphere", "气溶胶": "aerosol",
    "太阳辐射": "solar radiation", "大气环流": "atmospheric circulation",
    "季风": "monsoon",
    # 遥感
    "遥感": "remote sensing", "卫星遥感": "satellite remote sensing",
    "激光雷达": "LiDAR", "合成孔径雷达": "synthetic aperture radar",
    "植被指数": "vegetation index",
    "多光谱": "multispectral", "高光谱": "hyperspectral",
    "空间分辨率": "spatial resolution", "反演": "inversion",
    # 地理信息系统
    "地理信息系统": "geographic information system",
    "空间分析": "spatial analysis", "地理数据": "geospatial data",
    "空间插值": "spatial interpolation",
    "数字高程模型": "digital elevation model",
    "空间自相关": "spatial autocorrelation", "克里金插值": "kriging",
    # 可持续发展
    "碳交易": "carbon trading", "碳市场": "carbon market",
    "清洁能源": "clean energy", "循环经济": "circular economy",
    "绿色建筑": "green building", "可持续发展": "sustainable development",
    "生命周期评估": "life cycle assessment",
    "环境影响评价": "environmental impact assessment",
    # 其他环境
    "荒漠化": "desertification", "水土保持": "soil and water conservation",
    "地质灾害": "geological hazard", "滑坡": "landslide",
    "泥石流": "debris flow", "地面沉降": "land subsidence",
    "城市热岛": "urban heat island", "城市化": "urbanization",
    "土地利用": "land use", "土地覆盖": "land cover",

    # ========== 社会科学 ==========
    # 经济学
    "微观经济学": "microeconomics", "宏观经济学": "macroeconomics",
    "计量经济学": "econometrics", "博弈论": "game theory",
    "供需": "supply and demand", "边际效用": "marginal utility",
    "货币政策": "monetary policy", "财政政策": "fiscal policy",
    "通货膨胀": "inflation", "经济周期": "business cycle",
    "市场失灵": "market failure", "外部性": "externality",
    "机会成本": "opportunity cost", "人力资本": "human capital",
    # 管理学
    "组织行为": "organizational behavior", "战略管理": "strategic management",
    "人力资源": "human resource", "领导力": "leadership",
    "决策理论": "decision theory", "公司治理": "corporate governance",
    "运营管理": "operations management", "创新管理": "innovation management",
    "利益相关者": "stakeholder", "资源配置": "resource allocation",
    # 心理学
    "认知心理学": "cognitive psychology", "发展心理学": "developmental psychology",
    "社会心理学": "social psychology", "行为主义": "behaviorism",
    "人格": "personality", "情绪调节": "emotion regulation",
    "自我效能": "self-efficacy", "心理弹性": "resilience",
    "创伤后应激": "post-traumatic stress", "认知偏差": "cognitive bias",
    # 教育学
    "教学法": "pedagogy", "学习理论": "learning theory",
    "课程设计": "curriculum design", "教育公平": "educational equity",
    "批判性思维": "critical thinking", "形成性评估": "formative assessment",
    "混合式学习": "blended learning", "教育技术": "educational technology",
    "元认知": "metacognition", "建构主义": "constructivism",
    # 社会学
    "社会结构": "social structure", "社会分层": "social stratification",
    "社会资本": "social capital", "社会网络": "social network",
    "社会不平等": "social inequality", "文化资本": "cultural capital",
    "移民": "migration", "人口老龄化": "population aging",
    "社会流动性": "social mobility", "社会认同": "social identity",
    "社会规范": "social norm",
    # 政治学
    "政治理论": "political theory", "国际关系": "international relations",
    "公共政策": "public policy", "治理": "governance",
    "民主": "democracy", "地缘政治": "geopolitics",
    "政治参与": "political participation", "选举": "election",
    "主权": "sovereignty", "多边主义": "multilateralism",
    "国际安全": "international security",
    # 法学
    "法理学": "jurisprudence", "比较法": "comparative law",
    "国际法": "international law", "知识产权": "intellectual property",
    "人权": "human rights", "合同法": "contract law",
    "宪法": "constitutional law", "合规": "compliance",
    "仲裁": "arbitration", "侵权": "tort",
    # 新闻传播学
    "媒介理论": "media theory", "舆论": "public opinion",
    "数字传播": "digital communication", "框架理论": "framing theory",
    "议程设置": "agenda setting", "媒介素养": "media literacy",
    "跨文化传播": "intercultural communication", "信息茧房": "filter bubble",
    # 语言学
    "语义学": "semantics", "语用学": "pragmatics", "句法学": "syntax",
    "二语习得": "second language acquisition",
    "社会语言学": "sociolinguistics", "语料库语言学": "corpus linguistics",
    "话语分析": "discourse analysis", "认知语言学": "cognitive linguistics",
    "应用语言学": "applied linguistics",
    # 历史学
    "史料": "historical sources", "史学方法": "historiography",
    "口述历史": "oral history", "历史唯物主义": "historical materialism",
    "文化史": "cultural history", "社会史": "social history",
    "经济史": "economic history", "全球史": "global history",

    # ========== 通用学术术语 ==========
    "综述": "review", "进展": "progress", "研究": "research",
    "应用": "application", "性能": "performance", "结构": "structure",
    "制备": "preparation", "表征": "characterization",
    "机理": "mechanism", "动力学": "kinetics", "热力学": "thermodynamics",
    "创新": "innovation", "优化": "optimization", "策略": "strategy",
    "挑战": "challenge", "前景": "perspective", "趋势": "trend",
    "比较": "comparison", "影响": "influence", "因素": "factor",
    "模型": "model", "框架": "framework", "方法": "method",
    "技术": "technology", "系统": "system", "分析": "analysis",
    "设计": "design", "开发": "development", "评价": "evaluation",
}
...
class HybridTranslator:
    ...
    def __init__(self, ai_provider=None, cache_file: str = None):
        ...
        self._sorted_dict = sorted(_ZH_EN_DICT.items(), key=lambda x: len(x[0]), reverse=True)
...
def _dict_to_paper(d: dict) -> Paper:
    ...
    try:
        return Paper(
            ...
            notes=d.get("notes", ""),
            related_versions=d.get("related_versions", []) if isinstance(d.get("related_versions"), list) else [],
...
class BaseSearchSource(ABC):
    ...
    @abstractmethod
    def search(self, query: str, year_from: int, year_to: int,
               max_results: int = 50, **kwargs) -> list:
        """执行搜索，返回 Paper 列表。
...
JOURNAL_GROUPS = {
    "nature": [
        "Nature", "Nat Methods", "Nat Photonics", "Nat Cell Biol",
        "Nat Neurosci", "Nat Biotechnol", "Nat Commun", "Nat Chem",
        "Nat Phys", "Nat Mater", "Nat Med", "Nat Biomed Eng",
        "Nat Genet", "Nat Immunol", "Nat Struct Mol Biol",
        "Nat Rev Mol Cell Biol", "Nat Rev Neurosci", "Nat Rev Genet",
        "Nat Rev Immunol", "Nat Rev Drug Discov", "Nat Hum Behav",
        "Nature Aging", "Nature Cancer", "Nat Metab", "Nat Cardiovasc Res",
        "Nat Chem Biol", "Nat Ecol Evol", "Nat Electron", "Nat Energy",
        "Nat Food", "Nat Nanotechnol", "Nat Protoc",
        "Nat Rev Clin Oncol", "Nat Rev Chem", "Nat Rev Phys",
        "Nat Rev Mater", "Nat Rev Methods Primers",
    ],
    "cell": [
        "Cell", "Cell Rep", "Cell Stem Cell", "Cell Metab",
        "Mol Cell", "Cancer Cell", "Neuron", "Immunity",
        "Cell Host Microbe", "Cell Syst", "Cell Chem Biol",
        "Cell Rep Med", "Cell Rep Phys Sci", "Cell Genomics",
        "iScience", "Chem", "Joule", "Matter", "One Earth", "Patterns",
    ],
    "science": [
        "Science", "Sci Adv", "Sci Transl Med", "Sci Immunol",
        "Sci Robot", "Sci Signal",
    ],
}
...
class OpenAlexSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
               max_results=50, journal="", field="") -> list:
        """OpenAlex 检索"""
        # 动态获取当前年份
        if not year_to:
            year_to = datetime.now().year
        ...
        for part in bool_parts:
            ...
            for word in re.split(r'\s+', part):
                ...
                if (len(word) > 2 or (len(word) == 2 and any(c.isdigit() for c in word))) and \
                   word.lower() not in ('and', 'or', 'not', 'the', 'for', 'with'):
        ...
        if year_from or year_to:
            filter_parts.append(f"publication_year:{effective_year_from}-{year_to or datetime.now().year}")
        if journal:
            ...
            if len(all_journals) > MAX_JOURNAL_FILTER:
                print(f"[OpenAlex] Journal filter too long ({len(all_journals)} names), truncating to first {MAX_JOURNAL_FILTER}")
                all_journals = all_journals[:MAX_JOURNAL_FILTER]
            if len(all_journals) > 10:
                journal_batches = [all_journals[i:i+10] for i in range(0, len(all_journals), 10)]
                journal_filters = [f"primary_location.source.display_name:{'|'.join(batch)}" for batch in journal_batches]
                filter_parts.append(f"({'|'.join(journal_filters)})")
            elif all_journals:
                filter_parts.append(f"primary_location.source.display_name:{'|'.join(all_journals)}")
        ...
        if field == "au" and clean_query:
            # 作者搜索：使用 authorships.author.display_name
        ...
        try:
            ...
            if keywords and len(keywords) >= 2:
                ...
                for p in results:
                    ...
                    title_match = any(re.search(r'\b' + re.escape(kw) + r'\b', title_lower) for kw in keywords)
                    abstract_match = sum(1 for kw in keywords if re.search(r'\b' + re.escape(kw) + r'\b', abstract_lower)) >= 1
    ...
    def enrich_with_citations(self, papers: list) -> list:
        ...
        batches = [papers_with_doi[i:i+25] for i in range(0, len(papers_with_doi), 25)]
...
class PlaywrightBrowser:
    ...
    def _init_browser(self):
        try:
            ...
            try:
                PlaywrightBrowser._browser = PlaywrightBrowser._playwright.chromium.launch(channel="chrome", **launch_args)
...
class CNKISearch:
    ...
    def _validate_carsi_cookies(self):
        ...
        try:
            ...
            r = req.get("https://fsso.cnki.net/", cookies=cnki_cookies,
    ...
    def _check_captcha(self, page) -> bool:
        ...
        try:
            ...
            try:
                ...
                captcha_keywords = ['请完成验证', '安全验证', '拖动滑块', '请按住', '请完成安全验证',
                                   '点击按钮进行验证', '滑动完成验证', '向右拖动滑块']
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        if self.cookies and isinstance(self.cookies, dict):
            ...
            if browser_reuse or self._cookies_valid is None or (now - self._cookies_last_checked > self._COOKIE_CHECK_INTERVAL):
            ...
            try:
                ...
                while waited < max_wait:
                    ...
                    try:
                        ...
                        page.wait_for_timeout(5000); waited += 5
                ...
                for raw in papers_raw[:max_results]:
                    ...
                    if raw.get("authors"):
                        p.authors = [a.strip() for a in raw["authors"].replace(";", ";").split(";") if a.strip()]
                    ...
                    if p.doi and (not p.volume or not p.pages):
                        try:
                            ...
                            if record:
                                if not p.volume: p.volume = str(record.get("volume", "") or "")
                                if not p.issue: p.issue = str(record.get("issue", "") or "")
                                if not p.pages: p.pages = str(record.get("page", "") or "")
                                if not p.abstract: p.abstract = (record.get("abstract", "") or "")[:500]
                        except Exception:
                            pass
                    papers.append(p)
                ...
                for p in papers:
                    ...
                    try:
                        ...
                        if detail.get("abstract"):
                            ...
                            detail_count += 1
                            print(f"CNKI: 详情页提取摘要 [{detail_count}]: {p.title[:40]}...")
    ...
    def _parse_vol_issue_pages(paper, source_text):
        ...
        if m:
            if not paper.volume: paper.volume = m.group(1)
            if not paper.issue: paper.issue = m.group(2)
            if not paper.pages: paper.pages = m.group(3).rstrip(".,;")
            return
        # 仅匹配 "卷(期)" 无页码
    ...
    def _fetch_crossref_record(doi):
        ...
        try:
            ...
            r = _req.get(f"https://api.crossref.org/works/{doi}", timeout=10,
...
def _fetch_chinese_detail_abstracts(papers: list):
    ...
    def _fetch(p):
        if p.abstract or not getattr(p, '_detail_url', ''):
            return
        try:
            r = requests.get(p._detail_url, timeout=10,
                            headers={"User-Agent": "Mozilla/5.0"})
            r.encoding = "utf-8"
            soup = BeautifulSoup(r.text, "html.parser")
            abs_el = soup.select_one("div.abstract, div.detail-box .abstract, .article-abstract, #abstract, div.row-abstract p")
            if abs_el:
            ...
            if kw_els and not p.keywords:
                p.keywords = [k.get_text(strip=True) for k in kw_els[:10] if k.get_text(strip=True)]
        except Exception:
            pass
...
class WanfangSearch:
    ...
    def __init__(self, proxy=None, cookie="", access_proxy=None, cookies=None, wanfang_cookies=None):
        self.session = requests.Session()
                        ...
                        try:
                            ...
                            if record:
                                ...
                                if not p.issue:
                                    ...
                                    if iss: p.issue = str(iss)
                                if not p.pages:
                                    pg = record.get("page", "")
                                    if pg: p.pages = str(pg)
                                if not p.abstract:
                                    ab = record.get("abstract", "")
                                    if ab: p.abstract = ab.strip()[:500]
                        except Exception:
                            pass
                    # 提取详情页链接用于摘要抓取
                    detail_url = None
        ...
        try:
            ...
            for attempt in range(3):
                ...
                if r.status_code == 403:
                    print(f"Semantic Scholar access denied (403), query may be rejected or API key required")
                    return []
                break
            r.raise_for_status()
            data = r.json()
...
class CrossRefSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        try:
            ...
            r = _http_retry(self.session, f"{self.BASE}/works", params=params, label="CrossRef")
            data = r.json()
            papers = []
...
class CrossRefPublisherSearch:
        ...
        try:
            ...
            for attempt in range(3):
                ...
                if r.status_code == 429:
                    ...
                    print(f"{self.source_name}: 429 限流，等待 {wait}s 后重试 ({attempt+1}/3)")
                    time.sleep(wait)
                    continue
                break
            r.raise_for_status()
            ...
            if enriched > 0:
                print(f"[{self.source_name}] DOI 富化: {enriched} 篇论文补全了标题/摘要")
            return papers
        except Exception as e:
    ...
    def _enrich_from_full_records(self, papers: list) -> int:
        ...
        with ThreadPoolExecutor(max_workers=4) as executor:
            future_map = {executor.submit(self._fetch_full_record, p.doi): p for p in batch}
...
def _enrich_dblp_abstracts(papers: list):
    ...
    def _fetch(p):
        ...
        try:
            if p.doi:
                r = requests.get(f"https://api.crossref.org/works/{p.doi}", timeout=10,
                                headers={"User-Agent":"PaperLens/1.0"})
                if r.status_code == 200 and r.json().get("message",{}).get("abstract"):
                    p.abstract = r.json()["message"]["abstract"][:500]
                    return
            if p.title:
                r2 = requests.get("https://api.semanticscholar.org/graph/v1/paper/search",
                    params={"query":p.title,"limit":1,"fields":"title,abstract"}, timeout=10)
                if r2.status_code == 200:
                    d = r2.json().get("data",[])
                    if d and d[0].get("abstract"): p.abstract = d[0]["abstract"][:500]
        except Exception: pass
    needs = [p for p in papers if not p.abstract]
    if needs:
        print(f"DBLP: S2/CrossRef 补摘要 {len(needs)} 篇...")
        with ThreadPoolExecutor(max_workers=3) as ex: list(ex.map(_fetch, needs))
...
class BioRxivSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        try:
            # 清理 PubMed 字段标签语法
            clean_query = re.sub(r'\[(ti|tiab|au|ta|tw|mh|pt|pdat)\]', '', query, flags=re.IGNORECASE).strip()
            ...
            search_query = f'{clean_query} AND (PUBLISHER:"bioRxiv" OR PUBLISHER:"medRxiv")'
            if year_from and year_to:
                search_query += f" AND (FIRST_PDATE:[{year_from}-01-01 TO {year_to}-12-31])"
            elif year_from:
            ...
            for item in results:
                try:
                    ...
                    journal_abbr = (journal_obj.get("medlineAbbreviation") or "").lower()
                    source_name = "medrxiv" if ("medrxiv" in publisher.lower() or
                                                  "medrxiv" in journal_title or
                                                  "medrxiv" in journal_abbr) else "biorxiv"
                    ...
                    for u in url_list:
                        if u.get("documentStyle") == "html" or u.get("availability") == "Open access":
                            p.oa_url = u.get("url", "")
                            break
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        try:
            ...
            for attempt in range(3):
                ...
                if r.status_code == 429:
                    wait = min(2 ** attempt * 2, 10)
                    print(f"AGRIS rate limited, waiting {wait}s (attempt {attempt+1}/3)")
                    time.sleep(wait)
                    continue
                break
            if r.status_code == 404:
                print(f"AGRIS: API 端点返回 404，可能已迁移。跳过此数据源。")
                return []
            r.raise_for_status()
            data = r.json()
            ...
            for record in records:
                try:
                    ...
                    # 摘要
                    abstract = record.get("description", "") or record.get("abstract", "")
                    if abstract:
                        p.abstract = abstract.strip()[:500]

                    # 期刊/来源
                    source_title = record.get("journalTitle", "") or record.get("sourceTitle", "")
                    if source_title:
...
class ScraperAPIProxy:
    ...
    def get(self, url, params=None, timeout=30, **kwargs):
        ...
        return requests.get(self.BASE, params=proxy_params, headers=headers, timeout=timeout)
...
class JstorSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        try:
            ...
            r = self.session.get(f"{self.BASE}/search/do/basic", params=params, timeout=15)
            if r.status_code != 200:
                return []
            r.encoding = "utf-8"
            soup = BeautifulSoup(r.text, "html.parser")
        ...
        try:
            ...
            for item in data.get("results", []):
                try:
                    ...
                    p.doi = item.get("doi", "") or ""
                    p.year = 0
                    pub_year = item.get("yearPublished") or item.get("publishedDate", "")
                    if pub_year:
                        try:
...
class LensSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
               max_results=50, patent_mode=False) -> list:
        """搜索 Lens.org 学术文献或专利
        ...
        try:
            ...
            if year_from or year_to:
                ...
                must_clauses.append({
                    "range": {"year_published": year_range}
                })
            ...
            for hit in data.get("hits", {}).get("hits", []):
                try:
                    ...
                    if patent_mode:
                        ...
                        if isinstance(inventors, list):
                            for inv in inventors[:10]:
                                if isinstance(inv, dict):
                                    name = inv.get("name", "") or f"{inv.get('first_name', '')} {inv.get('last_name', '')}".strip()
                                else:
                                    name = str(inv)
                                if name:
                                    p.authors.append(name)
                        ...
                        # 全文链接
                        p.oa_url = source.get("granted_bibliographic_data_url", "") or ""
                    else:
                        # 学术文献解析（保持原有逻辑）
                        p.doc_type = "paper"
                        p.title = source.get("title", "") or ""
                        ...
                        if pg:
                            p.pages = str(pg)
                        # 引用数
                        p.citation_count = source.get("scholarly_citations_count", 0) or 0
                        # 关键词
...
class UnpaywallSearch:
    ...
    def enrich_papers(self, papers: list, max_workers: int = 4) -> list:
        ...
        with ThreadPoolExecutor(max_workers=min(max_workers, len(needs_enrich))) as executor:
        ...
        print(f"[Unpaywall] 完成: {enriched}/{len(needs_enrich)} 获取到 OA 链接 | "
...
class JstageSearch:
    ...
    def search(self, query: str, year_from=0, year_to=0,
               max_results=20) -> list:
        if not year_to:
            year_to = datetime.now().year
    ...
    def get(self, query: str, year_from, year_to, sources_hash: str):
        ...
        with self._lock:
            ...
            for dy in [(1, 0), (0, 1), (1, 1)]:
                super_key = self._make_key(query,
                    max(year_from - dy[0], 0), year_to + dy[1], sources_hash)
                entry = self._cache.get(super_key)
                if entry is not None and now - entry["ts"] <= self._ttl:
                    # 过滤到目标年份范围
                    papers = [p for p in entry["papers"]
        ...
        if self._persistent is not None:
            ...
            if l2_result is not None:
                ...
                if not valid_papers:
                    print(f"[WARN] L2 cache returned no valid Paper objects, skipping")
                    return None
                # L2 命中：回填 L1
                with self._lock:
...
class SQLiteSearchCache:
    ...
    def _put_sync(self, query_hash: str, query_text: str, papers):
        ...
        try:
            ...
            serializable = [_paper_to_dict(p) if isinstance(p, Paper) else p for p in papers]
            ...
            try:
                ...
                for query_text, created_at, results_json in rows:
                    ...
                    results.append({
                        ...
                        "result_count": len(papers) if isinstance(papers, list) else 0,
                    })
                return results
            finally:
                conn.close()
...
class SourceHealthMonitor:
    ...
    def _check_auto_disable(self, source_name: str):
        ...
        if consecutive_fails >= self._consecutive_fail_threshold:
            ...
            print(f"[HEALTH] Auto-disabled {source_name}: {consecutive_fails} consecutive failures")
            return
    ...
    def _compute_status(self, history: list) -> str:
        ...
        if success_rate < self._low_success_rate or avg_time > self._very_slow_threshold:
            return "red"
...
class GoogleScholarSource(BaseSearchSource):
    ...
    def search(self, query, year_from, year_to, max_results=20, **kwargs):
        return self._impl.search(query, year_from, year_to,
                                 max_results=min(max_results, self.MAX_RESULTS))
...
class PubAgSource(BaseSearchSource):
    ...
    def search(self, query: str, year_from: int = 0, year_to: int = 0,
               max_results: int = 30, **kwargs) -> list:
        try:
            params = {"query": query, "pageSize": min(max_results, 50), "format": "json"}
            ...
            for hit in data.get("results", []):
                try:
                    ...
                    p.journal = hit.get("journal", {}).get("name", "") if isinstance(hit.get("journal"), dict) else (hit.get("journal", "") or "")
                    authors = hit.get("authors", [])
                    p.authors = [a.get("name", "") or f"{a.get('firstName','')} {a.get('lastName','')}".strip() for a in authors]
                    date = hit.get("publicationDate", "") or ""
                    if date:
                        try: p.year = int(date[:4])
                        except ValueError: pass
...
class CochraneSearch:
    ...
    def search(self, query: str, year_from=2020, year_to=0,
        ...
        try:
            r = None
            for attempt in range(3):
                r = self.session.get(f"{self.BASE}/esearch.fcgi",
    ...
    def _fetch_details(self, pmids: list) -> list:
        ...
        for i in range(0, len(pmids), 100):
            ...
            try:
                r = None
                for attempt in range(3):
                    r = self.session.get(f"{self.BASE}/efetch.fcgi",
...
class FrontiersSource(BaseSearchSource):
    ...
    def search(self, query: str, year_from: int = 0, year_to: int = 0,
               max_results: int = 30, **kwargs) -> list:
        try:
            params = {"q": query, "size": min(max_results, 50), "sort": "relevance"}
            r = self.session.get(f"{self.BASE}/articles/search", params=params, timeout=15)
            r.raise_for_status()
            data = r.json()
            papers = []
        ...
        try:
            ...
            for item in data.get("message", {}).get("items", []):
                try:
                    ...
                    p.year = item.get("published-print", {}).get("date-parts", [[0]])[0][0]
                    authors = item.get("author", [])
...
# 注册 CrossRef 出版商
_publisher_configs = {
    "acs": 316, "optica": 285, "iop": 266, "aip": 317,
    "rsc": 292, "springer": 297, "wiley": 311, "ieee": 263, "muse": 147,
    "jstor": 337, "frontiers": 1965, "acm": 320,
    "oup": 286, "cup": 56, "sage": 179, "taylor_francis": 301, "ebsco": 324,
}
_publisher_display = {
    "acs": "ACS", "optica": "Optica", "iop": "IOP", "aip": "AIP",
    "rsc": "RSC", "springer": "Springer", "wiley": "Wiley", "ieee": "IEEE",
    "muse": "MUSE", "jstor": "JSTOR", "frontiers": "Frontiers", "acm": "ACM",
    "oup": "Oxford Academic", "cup": "Cambridge Core", "sage": "SAGE",
    "taylor_francis": "Taylor & Francis", "ebsco": "EBSCO",
}
    ...
    def search(self, query: str, year_from: int = 0, year_to: int = 0,
        ...
        try:
            ...
            if not carsi.is_authenticated():
                return []
            papers = carsi.search_wos(query, year_from, year_to, max_results)
            return papers
        except Exception as e:
...
class ProQuestSource(BaseSearchSource):
    ...
    def search(self, query: str, year_from: int = 0, year_to: int = 0,
               max_results: int = 20, **kwargs) -> list:
        if not self.is_available():
            return []
        try:
            from access_proxy import CARSIAuth
            ...
            if not carsi.is_authenticated():
                return []
            papers = carsi.search_proquest(query, year_from, year_to, max_results)
            return papers
        except Exception as e:
...
_DISCIPLINE_KEYWORDS: dict = {
    ...
    "cs": {
        "keywords": {
            "algorithm": 2, "machine learning": 3, "deep learning": 3,
            "neural network": 3, "artificial intelligence": 3,
            "natural language processing": 3, "computer vision": 3,
            "reinforcement learning": 2, "transformer": 2, "attention mechanism": 2,
            "convolutional neural": 2, "generative adversarial": 2,
            "graph neural": 2, "federated learning": 2,
            "software engineering": 2, "programming": 1,
            "database": 1, "network": 1, "security": 1,
            "distributed system": 2, "cloud computing": 2,
            "big data": 2, "data mining": 2, "information retrieval": 2,
            "recommender system": 2, "speech recognition": 2,
            "image segmentation": 2, "object detection": 2,
            "text classification": 2, "sentiment analysis": 2,
            "knowledge graph": 2, "semantic web": 2,
            "blockchain": 2, "internet of things": 2, "iot": 1,
            "cybersecurity": 2, "cryptography": 2,
            "operating system": 2, "compiler": 2, "robotics": 2,
        },
    ...
    "medicine": {
        "keywords": {
            "clinical trial": 3, "patient": 2, "diagnosis": 2,
            "treatment": 2, "therapy": 2, "disease": 2,
            "cancer": 2, "tumor": 2, "carcinoma": 2,
            "cardiovascular": 2, "cardiac": 2,
            "neurodegenerative": 2, "alzheimer": 2, "parkinson": 2,
            "immunology": 2, "immune": 2, "antibody": 2,
            "pharmacology": 2, "drug": 2, "pharmaceutical": 2,
            "pathology": 2, "pathogen": 2, "infection": 2,
            "epidemiology": 2, "public health": 2,
            "surgery": 2, "surgical": 2,
            "radiology": 2, "mri": 1, "ct scan": 1,
            "biomarker": 2, "prognosis": 2,
            "randomized controlled": 3, "meta-analysis": 2,
            "systematic review": 2, "cohort study": 2,
            "case report": 1, "case series": 1,
            "nih": 1, "pubmed": 1, "mesh": 1,
            "oncology": 2, "hematology": 2, "gastroenterology": 2,
            "dermatology": 2, "ophthalmology": 2, "psychiatry": 2,
            "pediatrics": 2, "obstetrics": 2, "gynecology": 2,
            "anesthesiology": 2, "emergency medicine": 2,
        },
    ...
    "chemistry": {
        "keywords": {
            "synthesis": 1, "catalyst": 2, "catalysis": 2,
            "organic chemistry": 3, "inorganic chemistry": 3,
            "polymer": 2, "nanoparticle": 1, "nanostructure": 1,
            "spectroscopy": 2, "chromatography": 2,
            "crystal structure": 2, "x-ray diffraction": 2,
            "nuclear magnetic resonance": 3, "nmr": 1,
            "mass spectrometry": 2, "electrochemistry": 2,
            "photochemistry": 2, "electrolyte": 2,
            "functional group": 2, "reaction mechanism": 2,
            "stoichiometry": 2, "titration": 2,
            "coordination compound": 3, "metal-organic framework": 3,
            "mof": 1, "covalent organic framework": 3,
            "polymerization": 2, "copolymer": 2,
            "surface chemistry": 2, "colloid": 2,
            "supramolecular": 2, "self-assembly": 1,
            "green chemistry": 2, "catalytic": 2,
        },
        "sources": {"acs", "rsc", "sciencedirect", "crossref", "springer", "scopus", "lens"},
    },
    # 物理学
    "physics": {
        "keywords": {
            "quantum mechanics": 3, "quantum field": 3,
            "condensed matter": 3, "superconductor": 2,
            "semiconductor": 2, "photonics": 2, "optics": 2,
            "laser": 2, "optical": 1,
            "particle physics": 3, "hadron": 2, "boson": 2,
            "fermion": 2, "quark": 2, "higgs": 2,
            "astrophysics": 3, "cosmology": 3, "dark matter": 3,
            "dark energy": 3, "neutron star": 2, "black hole": 2,
            "gravitational wave": 3, "galaxy": 2,
            "thermodynamics": 2, "statistical mechanics": 3,
            "electrodynamics": 2, "electromagnetic": 1,
            "plasma physics": 3, "fluid dynamics": 2,
            "turbulence": 2, "magnetism": 2, "magnetic field": 1,
            "topological": 2, "spintronics": 2,
            "photovoltaic": 2, "solar cell": 2,
            "spectroscopy": 1, "diffract": 1,
        },
        "sources": {"iop", "aip", "arxiv", "springer", "sciencedirect", "crossref", "scopus", "lens"},
    },
    # 生物学
    "biology": {
        "keywords": {
            "genome": 2, "genomics": 3, "gene expression": 3,
            "transcriptomics": 3, "proteomics": 3, "metabolomics": 3,
            "crispr": 3, "gene editing": 3, "gene therapy": 3,
            "cell biology": 3, "cell signaling": 3,
            "apoptosis": 2, "autophagy": 2, "mitosis": 2,
            "evolution": 2, "phylogenetics": 3, "population genetics": 3,
            "ecology": 2, "biodiversity": 2, "conservation": 1,
            "microbiology": 3, "virology": 3, "bacteriology": 3,
            "immunology": 1, "vaccine": 2,
            "neuroscience": 2, "neuron": 2, "synapse": 2,
            "bioinformatics": 3, "sequence alignment": 3,
            "protein structure": 3, "molecular dynamics": 2,
            "enzyme": 2, "receptor": 2, "ligand": 1,
            "stem cell": 3, "organoid": 3,
            "metagenomics": 3, "microbiome": 3,
            "rna": 1, "mrna": 2, "lncrna": 2,
            "epigenetics": 3, "methylation": 2,
        },
        "sources": {"biorxiv", "pubmed", "europepmc", "sciencedirect", "crossref", "springer", "scopus", "lens"},
    },
    # 材料科学
    "materials": {
        "keywords": {
            "nanomaterial": 2, "nanoparticle": 2, "nanotube": 2,
            "nanowire": 2, "nanosheet": 2, "quantum dot": 2,
            "graphene": 3, "carbon nanotube": 3, "mxene": 3,
            "perovskite": 2, "thin film": 2, "coating": 1,
            "alloy": 2, "composite": 2, "polymer": 1,
            "ceramic": 2, "hydrogel": 2, "biomaterial": 2,
            "superconductor": 1, "semiconductor": 1,
            "photovoltaic": 2, "solar cell": 2,
            "battery": 2, "supercapacitor": 2, "energy storage": 2,
            "catalyst": 1, "electrocatalysis": 2, "photocatalysis": 2,
            "corrosion": 2, "wear": 1, "hardness": 1,
            "tensile strength": 2, "fatigue": 1, "fracture": 1,
            "x-ray diffraction": 2, "scanning electron microscope": 2,
            "transmission electron microscope": 3, "sem": 1, "tem": 1,
            "atomic force microscope": 3, "afm": 1,
            "chemical vapor deposition": 3, "cvd": 1,
            "sputtering": 2, "electrospinning": 2,
            "3d printing": 2, "additive manufacturing": 2,
            "shape memory": 2, "piezoelectric": 2,
            "thermoelectric": 2, "ferroelectric": 2,
            "magnetic material": 2, "optical material": 2,
        },
        "sources": {"acs", "rsc", "sciencedirect", "springer", "scopus", "crossref", "iop", "aip", "lens"},
    },
    # 农业科学
    "agriculture": {
        "keywords": {
            "agriculture": 3, "agronomy": 3, "crop": 2,
            "soil": 2, "fertilizer": 2, "irrigation": 2,
            "pesticide": 2, "herbicide": 2, "insecticide": 2,
            "plant breeding": 3, "plant pathology": 3,
            "food safety": 2, "food science": 3, "nutrition": 2,
            "livestock": 2, "animal science": 2, "veterinary": 2,
            "forestry": 2, "silviculture": 2,
            "aquaculture": 2, "fisheries": 2,
            "horticulture": 2, "viticulture": 2,
            "organic farming": 2, "sustainable agriculture": 3,
            "precision agriculture": 3, "remote sensing": 1,
            "yield": 1, "germplasm": 2, "cultivar": 2,
        },
        "sources": {"agris", "pubmed", "crossref", "sciencedirect", "springer", "scopus", "lens"},
    },
    # 工程学
    "engineering": {
        "keywords": {
            "control system": 3, "signal processing": 3,
            "power electronics": 3, "electric motor": 2,
            "power grid": 2, "renewable energy": 2,
            "wind energy": 2, "hydrogen": 1,
            "structural engineering": 3, "finite element": 3,
            "civil engineering": 3, "geotechnical": 3,
            "fluid mechanics": 2, "thermodynamics": 1,
            "manufacturing": 2, "automation": 2,
            "mechatronics": 3, "embedded system": 3,
            "vlsi": 3, "digital signal": 3,
            "telecommunication": 3, "5g": 2, "6g": 2,
            "antenna": 2, "microwave": 2, "radar": 2,
            "image processing": 2, "pattern recognition": 2,
            "control theory": 3, "pid controller": 3,
            "robotics": 1, "drone": 2, "uav": 2,
            "traffic": 1, "transportation": 2,
        },
        "sources": {"ieee", "springer", "sciencedirect", "arxiv", "crossref", "scopus", "iop", "aip", "lens"},
    },
    # 人文社科
    "humanities": {
        "keywords": {
            "philosophy": 3, "ethics": 2, "epistemology": 3,
            "aesthetics": 2, "metaphysics": 3,
            "history": 2, "historiography": 3, "archaeology": 3,
            "literature": 2, "literary": 2, "narrative": 1,
            "linguistics": 3, "syntax": 2, "semantics": 2,
            "sociology": 3, "anthropology": 3, "ethnography": 3,
            "political science": 3, "international relations": 3,
            "economics": 2, "econometrics": 3,
            "psychology": 2, "cognitive science": 3,
            "education": 2, "pedagogy": 3,
            "law": 2, "legal": 2, "jurisprudence": 3,
            "art": 1, "culture": 1, "religion": 2,
            "gender studies": 3, "postcolonial": 3,
            "media studies": 3, "communication": 2,
        },
...
class DisciplineRouter:
    ...
    def detect_disciplines(cls, query: str) -> list:
        ...
        stopwords = {
            "and", "or", "not", "the", "for", "with", "from", "in",
            "on", "at", "to", "of", "by", "is", "are", "was", "were",
            "a", "an", "this", "that", "these", "those", "it", "its",
        }
        words = set(w.strip("()'\"") for w in re.split(r'[\s+,;:]+', query_lower)
    ...
    def filter_sources(cls, query: str, enabled_sources: set) -> set:
        ...
        if not filtered:
            print(f"[ROUTER] 过滤后为空，回退到原始源集合")
            return enabled_sources

        original_count = len(enabled_sources)
        filtered_count = len(filtered)
        disc_names = ", ".join(d for d, _ in disciplines)
        print(f"[ROUTER] 学科: {disc_names} | 源: {original_count} -> {filtered_count} "
...
class QueryUnderstanding:
    ...
    _YEAR_PATTERNS = [
        re.compile(r'(?:in\s+|年份[:：]?\s*)?(\d{4})\s*(?:年|papers?|年份)?', re.IGNORECASE),
    ]
    ...
    AUTHOR_PATTERNS = [
        ...
        re.compile(r'(?:作者|author)[：:]\s*((?:[A-Z][a-z]*\.?(?:\s+(?=[A-Z]))?){1,3})'),
    ...
    _TIME_WORDS = {
        ...
        '上个月', '下个月', '本月', '全天', '每年', '每月',
        '近年', '近期', '先前', '今后', '此后', '以来',
        '近三年', '最近三年', '过去三年', '近五年', '最近五年',
        '过去五年', '近十年', '最近十年', '过去十年',
        '近三年的', '最近三年的', '过去三年的',
        # 常见学术词汇（不应被识别为作者）
        '纳米', '材料', '量子', '基因', '蛋白', '细胞', '分子',
        '催化', '电池', '能源', '环境', '临床', '医学', '生物',
        '化学', '物理', '数学', '计算机', '人工智能', '深度学习',
        '机器学习', '数据分析', '文献', '综述', '研究', '论文',
    }
    ...
    def _clean_query(cls, text: str) -> str:
        ...
        for w in cleanup_words:
            text = text.replace(w, ' ')
        text = re.sub(r'\b(?:about|on|of|for|the|a|an|papers?|articles?)\b',
...
class ZoteroSQLiteReader:
    ...
    ZOTERO_FIELDS = {
        1: "title", 2: "abstractNote", 3: "DOI", 4: "url",
        5: "volume", 6: "issue", 7: "pages", 8: "publicationTitle",
        9: "date", 10: "series", 11: "language", 12: "ISBN",
        13: "ISSN", 14: "shortTitle", 15: "accessDate",
    }
    ...
    def find_profile_dir(custom_dir: str = "") -> str | None:
        ...
        if sys.platform == "win32":
            ...
            ini_candidates.append(_os.path.join(appdata, "Zotero", "Zotero", "profiles.ini"))
        elif sys.platform == "darwin":
            ini_candidates.append(_os.path.join(home, "Library", "Application Support", "Zotero", "profiles.ini"))
        else:
            ini_candidates.append(_os.path.join(home, ".zotero", "zotero", "profiles.ini"))
            ini_candidates.append(_os.path.join(home, ".var", "app", "org.zotero.Zotero", "data", "zotero", "zotero", "profiles.ini"))
        ...
        if sys.platform == "win32":
            appdata = _os.environ.get("APPDATA", home)
            base_candidates.append(_os.path.join(appdata, "Zotero", "Zotero", "Profiles"))
            ...
            if local:
                base_candidates.append(_os.path.join(local, "Zotero", "Zotero", "Profiles"))
        elif sys.platform == "darwin":
            base_candidates.append(_os.path.join(home, "Library", "Application Support", "Zotero", "Profiles"))
            base_candidates.append(_os.path.join(home, "Zotero"))
        else:
            base_candidates.append(_os.path.join(home, ".zotero", "zotero", "default"))
            base_candidates.append(_os.path.join(home, ".var", "app", "org.zotero.Zotero", "data", "zotero", "zotero", "default"))
            base_candidates.append(_os.path.join(home, "snap", "zotero-snap", "common", "Zotero", "Profiles"))
            base_candidates.append(_os.path.join(home, "Zotero"))
    ...
    def __init__(self, profile_dir: str = None):
        ...
        if self._profile:
            ...
            self._conn = sqlite3.connect(f"file:{self._db_path}?mode=ro", uri=True, timeout=5)
    ...
    def stats(self) -> dict:
        ...
        try:
            cur = self._conn.execute("SELECT COUNT(*) FROM items WHERE itemTypeID IN (SELECT itemTypeID FROM itemTypes WHERE typeName NOT IN ('attachment','note','annotation'))")
    ...
    def search(self, query: str, limit: int = 20, year_from: int = 0,
               year_to: int = 0) -> list:
...
class ZoteroNativeClient:
    ...
    def ping(self) -> bool:
        try:
            r = self._session.get(f"{self.base_url}/api/users/0/items/top?limit=1", timeout=5)
            return r.status_code == 200
        except Exception:
            return False

    def search(self, query: str, year_from: int = 0, year_to: int = 0, limit: int = 50) -> list:
        """搜索 Zotero 库，返回 Paper 对象列表"""
        papers = []
        try:
            ...
            for item in items:
                ...
                p.authors = [f"{c.get('firstName','')} {c.get('lastName','')}".strip()
                           for c in creators if c.get("creatorType") == "author"]
                # 标签
                tags = data.get("tags", [])
                p.keywords = [t.get("tag", "") for t in tags if t.get("tag")]
                # 期刊
                pub_title = data.get("publicationTitle", "") or data.get("libraryCatalog", "") or ""
                if pub_title:
                    p.journal = pub_title
                papers.append(p)
                if len(papers) >= limit:
    ...
    def get_tags(self) -> list:
        """获取所有标签及使用计数"""
        try:
            r = self._session.get(f"{self.base_url}/api/users/{self._user_id}/tags", timeout=self.timeout)
            if r.status_code != 200:
                return []
            tags = r.json()
            return [{"name": t.get("tag", ""), "count": t.get("meta", {}).get("numItems", 0)}
                    for t in tags]
        except Exception:
            return []
    ...
    def get_fulltext(self, item_key: str) -> str | None:
        ...
        try:
            # 获取子项（附件+笔记）
            r = self._session.get(f"{self.base_url}/api/users/{self._user_id}/items/{item_key}/children",
    ...
    def get_stats(self) -> dict:
        """获取库统计"""
        try:
            r = self._session.get(f"{self.base_url}/api/users/{self._user_id}/items/top?limit=1",
                                timeout=5)
            if r.status_code != 200:
                return {"items": 0, "tags": 0}
            tags = self.get_tags()
...
class ZoteroMCPClient:
    ...
    def _call(self, method, params=None):
        ...
        r.raise_for_status()
        data = r.json()
        if "error" in data: raise Exception(f"MCP Error: {data['error']}")
        return data.get("result", {})
    def ping(self):
        try: return self._session.get(f"{self.base_url}/ping", timeout=3).status_code == 200
        except: return False
    ...
    def search(self, query, limit=20, year_from=0, year_to=0, tags=None):
        ...
        if year_from > 0 and year_to > 0: args["yearRange"] = f"{year_from}-{year_to}"
        if tags: args["tags"] = tags; args["tagMode"] = "any"; args["tagMatch"] = "contains"
...
class ZoteroMCPSource(BaseSearchSource):
    ...
    def __init__(self, **config):
        ...
        try:
            ...
            if r.status_code == 200:
                self._mcp_client = ZoteroMCPClient(base_url=mcp_url) if 'ZoteroMCPClient' in globals() else None
                if self._mcp_client:
                    self._backend = "mcp"
                    return
        except Exception:
    ...
    def search(self, query: str, year_from: int = 0, year_to: int = 0,
        ...
        if self._backend == "mcp" and self._mcp_client:
            try:
                ...
                return []
        if self._backend == "sqlite" and self._sqlite:
            return self._sqlite.search(query, limit=max_results,
                                        year_from=year_from, year_to=year_to)
        return []

    def _search_mcp(self, query, year_from, year_to, max_results):
        results = self._mcp_client.search(query, limit=max_results,
                                           year_from=year_from, year_to=year_to)
        papers = []
        for item in results:
            try:
                ...
                if matched_tags: p.keywords = list(matched_tags)
                papers.append(p)
            except Exception:
                continue
        # 补全详细信息（最多 10 篇）
        for p in papers[:10]:
            try:
                ...
                if not r2: continue
                detail = self._mcp_client.get_item(r2[0].get("key", ""), mode="standard")
                if not detail: continue
                if not p.doi: p.doi = detail.get("DOI", "") or ""
                if not p.journal: p.journal = detail.get("publicationTitle", "") or ""
                if not p.volume: p.volume = str(detail.get("volume", "") or "")
                if not p.issue: p.issue = str(detail.get("issue", "") or "")
                if not p.pages: p.pages = str(detail.get("pages", "") or "")
                if not p.abstract: p.abstract = (detail.get("abstractNote", "") or "")[:500]
                tags = detail.get("tags", [])
                if tags and not p.keywords: p.keywords = [str(t) for t in tags[:10]]
                url = detail.get("url", "") or ""
                if url and not p.oa_url: p.oa_url = url
            except Exception:
                continue
        return papers
        ...
        try:
            ...
            for hit in data.get("hits", {}).get("hits", []):
                try:
                    ...
                    if isinstance(keywords, list):
                        p.keywords = [str(k) for k in keywords[:10]]
                    p.oa_url = hit.get("links", {}).get("self_html", "") or meta.get("doi_url", "") or ""
                    papers.append(p)
                except Exception:
                    continue
            return papers
...
class DataCiteSource(BaseSearchSource):
    ...
    def __init__(self, **config):
        super().__init__(**config)
        self.session = requests.Session()
        self.session.headers["User-Agent"] = "PaperLens/1.0 (mailto:vanthree31@gmail.com)"
        ...
        try:
            ...
            for item in data.get("data", []):
                try:
                    ...
                    p.abstract = (descs[0].get("description", "") if descs else "")[:500]
                    ...
                    if pub: p.journal = pub
                    subjects = attrs.get("subjects", [])
                    if subjects:
                        p.keywords = [s.get("subject","") for s in subjects[:10] if s.get("subject")]
                    if not p.oa_url:
                        p.oa_url = attrs.get("url", "") or f"https://doi.org/{p.doi}" if p.doi else ""
...
class SearchEngine:
    ...
    def __init__(self, config: dict):
        ...
        self.google_scholar = getattr(self._sources.get("google_scholar"), '_impl', None)
        ...
        self.semantic_scholar = getattr(self._sources.get("semantic_scholar"), '_impl', None)
    ...
    def preprocess_query(self, query: str, year_from=None, year_to=0,
                         pub_type="", author="") -> dict:
        """查询预处理：使用规则引擎提取结构化信息
        ...
        # 日志
        if parsed["year_from"] or parsed["pub_type"] or parsed["doi"] or parsed["author"]:
            print(f"[QUERY UNDERSTAND] '{query}' -> "
    ...
    def _match_journal(self, paper_journal: str, journals: list) -> bool:
        ...
        for j in journals:
            ...
            if j_lower in JOURNAL_GROUPS:
                ...
                if any(self._word_boundary_match(gj, paper_journal_lower) for gj in group_journals):
                    return True
    ...
    def _score_relevance(self, paper, keywords: set) -> float:
        ...
        for kw in keywords:
            ...
            if tf_abstract > 0:
                ...
                bm25_tf_abstract = (tf_abstract * (k1 + 1)) / (tf_abstract + k1 * norm_abstract)
    ...
    def search(self, query: str, year_from=None, year_to=0,
               sort="relevance", max_results=50,
               ...
               use_crossref=True, use_arxiv=True,
               use_sciencedirect=True, use_scopus=True, use_jstor=True,
               use_dblp=True, use_biorxiv=True, use_agris=True,
               use_acs=True, use_optica=True, use_iop=True, use_aip=True,
               use_rsc=True, use_europepmc=True,
        ...
        # 显式传入的参数优先级高于规则提取
        parsed_query = self.preprocess_query(
            query, year_from, year_to, pub_type)
        query = parsed_query["query"]
        # 仅当显式参数是默认值时，使用规则提取的值
        if year_from == current_year - 10 and parsed_query["year_from"] != current_year - 10:
        ...
        if parsed_query.get("doi"):
            ...
            if paper:
                return [paper], []
            # DOI 查询失败，回退到常规搜索
            print(f"[QUERY UNDERSTAND] DOI lookup failed, falling back to full search")
        ...
        sources_hash = self._compute_sources_hash(
            enabled_sources if enabled_sources is not None else (
                use_pubmed, use_openalex, use_google_scholar, use_cnki,
                use_wanfang, use_vip, use_bing_academic, use_semantic_scholar,
                use_crossref, use_arxiv, use_sciencedirect, use_scopus, use_jstor,
                use_dblp, use_biorxiv, use_agris,
                use_acs, use_optica, use_iop, use_aip, use_rsc, use_europepmc,
                use_springer, use_wiley, use_ieee, use_muse,
                use_core, use_lens,
            )
        )
        ...
        tasks = self._build_search_tasks(
            query_en, query_zh, year_from, year_to, sort, max_results,
            journal, field, mesh_term, pub_type,
            enabled_sources=enabled_sources,
            use_pubmed=use_pubmed, use_openalex=use_openalex,
            use_google_scholar=use_google_scholar, use_cnki=use_cnki,
            use_wanfang=use_wanfang, use_vip=use_vip,
            use_bing_academic=use_bing_academic,
            use_semantic_scholar=use_semantic_scholar,
            use_crossref=use_crossref, use_arxiv=use_arxiv,
            use_sciencedirect=use_sciencedirect, use_scopus=use_scopus,
            use_jstor=use_jstor,
            use_dblp=use_dblp, use_biorxiv=use_biorxiv, use_agris=use_agris,
            use_acs=use_acs, use_optica=use_optica, use_iop=use_iop,
            use_aip=use_aip, use_rsc=use_rsc, use_europepmc=use_europepmc,
            use_springer=use_springer, use_wiley=use_wiley,
            use_ieee=use_ieee, use_muse=use_muse,
            use_core=use_core, use_lens=use_lens, use_lens_patents=use_lens_patents,
        )
        ...
        unique, errors = self._post_process_results(
            all_papers, errors, query, query_en, is_chinese_query,
            year_from, year_to, sort, journals, field, pub_type, mesh_term)

        # --- 写入搜索结果缓存 ---
        self._search_cache.put(query, year_from, year_to, sources_hash, unique)
        stats = self._search_cache.stats()
        print(f"[CACHE PUT] query='{query[:50]}' | 结果 {len(unique)} 条 | "
    ...
    def _build_search_tasks(self, query_en, query_zh, year_from, year_to,
                            sort, max_results, journal, field, mesh_term, pub_type,
                            enabled_sources=None,
                            use_pubmed=True, use_openalex=True,
                            use_google_scholar=False, use_cnki=False,
                            use_wanfang=False, use_vip=False,
        ...
        if enabled_sources is not None:
            ...
            return self._build_tasks_from_registry(
                query_en, query_zh, year_from, year_to,
                sort, max_results, journal, field, mesh_term, pub_type,
                enabled_sources)

        # === 旧接口：use_xxx 参数（向后兼容） ===
        if use_pubmed and self.pubmed:
            tasks.append(("PubMed", lambda: self._search_pubmed(
                query_en, year_from, year_to, sort, max_results,
                journal, field, mesh_term, pub_type)))

        if use_openalex and self.openalex:
            tasks.append(("OpenAlex", lambda: self.openalex.search(
                query_en, year_from, year_to, max_results, journal=journal, field=field)))

        if use_google_scholar and self.google_scholar:
            tasks.append(("Google Scholar", lambda: self.google_scholar.search(
                query_en, year_from, year_to, max_results=min(max_results, 20))))

        # 中文数据库使用原始中文查询
        if use_cnki and self.cnki:
            tasks.append(("CNKI", lambda: self.cnki.search(
                query_zh, year_from, year_to, max_results=min(max_results, 20))))

        if use_wanfang and self.wanfang:
            tasks.append(("万方", lambda: self.wanfang.search(
                query_zh, year_from, year_to, max_results=min(max_results, 20), field=field)))

        if use_vip and self.vip:
            tasks.append(("维普", lambda: self.vip.search(
                query_zh, year_from, year_to, max_results=min(max_results, 20))))

        if use_bing_academic and self.bing_academic:
            tasks.append(("Bing Academic", lambda: self.bing_academic.search(
                query_en, year_from, year_to, max_results=min(max_results, 20))))

        # 英文数据库使用翻译后的英文查询
        if use_semantic_scholar and self.semantic_scholar:
            tasks.append(("Semantic Scholar", lambda: self.semantic_scholar.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_crossref and self.crossref:
            tasks.append(("CrossRef", lambda: self.crossref.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_arxiv and self.arxiv:
            tasks.append(("arXiv", lambda: self.arxiv.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        # 免费 API 数据源（英文）
        if use_dblp and self.dblp:
            tasks.append(("DBLP", lambda: self.dblp.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_biorxiv and self.biorxiv:
            tasks.append(("bioRxiv", lambda: self.biorxiv.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_agris and self.agris:
            tasks.append(("AGRIS", lambda: self.agris.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        # CrossRef 出版商过滤（免费 API，英文）
        if use_acs and self.acs:
            tasks.append(("ACS", lambda: self.acs.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_optica and self.optica:
            tasks.append(("Optica", lambda: self.optica.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_iop and self.iop:
            tasks.append(("IOP", lambda: self.iop.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_aip and self.aip:
            tasks.append(("AIP", lambda: self.aip.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_rsc and self.rsc:
            tasks.append(("RSC", lambda: self.rsc.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_europepmc and self.europepmc:
            tasks.append(("Europe PMC", lambda: self.europepmc.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        # CORE 和 Lens.org 数据源
        if use_core and self.core:
            tasks.append(("CORE", lambda: self.core.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_lens and self.lens:
            tasks.append(("Lens", lambda: self.lens.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_lens_patents and self.lens:
            tasks.append(("Lens Patent", lambda: self.lens.search(
                query_en, year_from, year_to, max_results=min(max_results, 50),
                patent_mode=True)))

        if use_springer and self.springer:
            tasks.append(("Springer", lambda: self.springer.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_wiley and self.wiley:
            tasks.append(("Wiley", lambda: self.wiley.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_ieee and self.ieee:
            tasks.append(("IEEE", lambda: self.ieee.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_muse and self.muse:
            tasks.append(("MUSE", lambda: self.muse.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        # CARSI 认证数据库（英文查询）
        if use_sciencedirect and self.sciencedirect:
            tasks.append(("ScienceDirect", lambda: self.sciencedirect.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_scopus and self.scopus:
            tasks.append(("Scopus", lambda: self.scopus.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        if use_jstor and self.jstor:
            tasks.append(("JSTOR", lambda: self.jstor.search(
                query_en, year_from, year_to, max_results=min(max_results, 50))))

        return tasks

    def _build_tasks_from_registry(self, query_en, query_zh, year_from, year_to,
                                    sort, max_results, journal, field, mesh_term, pub_type,
                                    enabled_sources):
        """注册表驱动的任务构建（新接口）
        ...
        for source_name in enabled_sources:
            ...
            is_chinese = getattr(source_cls, 'IS_CHINESE', False) if source_cls else False
            ...
            display_name = getattr(source_cls, 'DISPLAY_NAME', source_name) if source_cls else source_name
            ...
            tasks.append((display_name, lambda s=_src, q=_q, yf=_yf, yt=_yt, mr=_mr, kw=_kw, d=_need_delay:
    ...
    def _calc_completeness(p) -> int:
        ...
        score = 0
        if p.title: score += 12
        if p.authors: score += 10
        if p.journal: score += 8
        if p.year: score += 7
        if p.doi: score += 8
        if p.abstract: score += 18
        if p.volume: score += 5
        if p.issue: score += 4
        if p.pages: score += 5
        if p.issn: score += 3
        if p.keywords: score += 6
        if p.citation_count: score += 5
        if p.oa_url: score += 4
        if p.funding: score += 3
        if p.article_type: score += 2
        return min(score, 100)

    def _post_process_results(self, all_papers, errors, query, query_en,
                              is_chinese_query, year_from, year_to, sort,
                              journals, field, pub_type="", mesh_term=""):
        ...
        if needs_enrich:
            ...
            def _enrich_one(p):
                try:
                    r = requests.get(f"https://api.crossref.org/works/{p.doi}",
                                   headers={"User-Agent": "PaperLens/1.0"}, timeout=8)
                    if r.status_code != 200:
                        return False
                    msg = r.json().get("message", {})
                    enriched = False
                    ...
                    if not p.title or len(p.title) < 10:
                        ...
                        if titles: p.title = titles[0]; enriched = True
                    # 摘要
                    if not p.abstract:
                        abstract = msg.get("abstract") or ""
                        if abstract: p.abstract = abstract[:5000]; enriched = True
                    # 期刊
                    if not p.journal:
                        containers = msg.get("container-title") or []
                        if containers: p.journal = containers[0]; enriched = True
                    # 年份
                    if not p.year:
                        dp = msg.get("published-print") or msg.get("created") or {}
                        dates = dp.get("date-parts", [[0]])[0]
                        if dates[0]: p.year = dates[0]; enriched = True
                    # 作者
                    if not p.authors:
                        authors = msg.get("author") or []
                        p.authors = [f"{a.get('given','')} {a.get('family','')}".strip() for a in authors]
                        if p.authors: enriched = True
                    # 卷/期/页
                    if not p.volume:
                        p.volume = str(msg.get("volume") or "")
                        if p.volume: enriched = True
                    if not p.issue:
                        p.issue = str(msg.get("issue") or "")
                        if p.issue: enriched = True
                    if not p.pages:
                        p.pages = str(msg.get("page") or "")
                        if p.pages: enriched = True
                    # 出版商 + ISSN
                    publisher = msg.get("publisher") or ""
                    if publisher and not getattr(p, 'publisher', ''):
                        p.publisher = publisher; enriched = True
                    issn_list = msg.get("ISSN") or []
                    if issn_list and not getattr(p, 'issn', ''):
                        p.issn = issn_list[0]; enriched = True
                    return enriched
                except Exception:
                    return False
        ...
        if self.openalex and self.openalex._last_keywords:
            ...
            for w in re.split(r'\s+', query_en):
                w = w.strip('()"\' ')
                if len(w) > 2 and w.lower() not in ('and', 'or', 'not', 'the', 'for', 'with'):
        ...
        if keywords:
            ...
            if not journals and field != "au" and not is_chinese_query:
                unique = [p for p in unique if self._title_matches_keywords(p, keywords)]
            if sort == "relevance":
                # RRF 源质量加权：被多个高质量源收录的论文提权
                SOURCE_WEIGHTS = {
                    "pubmed": 1.0, "semantic_scholar": 0.9, "openalex": 0.85,
                    "scopus": 0.85, "sciencedirect": 0.85, "europepmc": 0.8,
                    "crossref": 0.7, "core": 0.7, "lens": 0.7,
                    "arxiv": 0.5, "biorxiv": 0.5, "dblp": 0.5,
                    "google_scholar": 0.6, "bing_academic": 0.5,
                    "cnki": 0.7, "wanfang": 0.7, "vip": 0.65,
                    "jstor": 0.75, "springer": 0.7, "wiley": 0.7, "ieee": 0.7,
                    "acs": 0.75, "optica": 0.75, "iop": 0.75, "aip": 0.75, "rsc": 0.75,
                    "muse": 0.7, "agris": 0.6, "zotero_mcp": 0.8, "zotero_local": 0.8,
                }
                for p in unique:
                    src_list = p.sources if p.sources else ([p.source] if p.source else [])
                    # 源质量分：收录源的加权平均
                    weights = [SOURCE_WEIGHTS.get(s, 0.5) for s in src_list]
                    src_quality = sum(weights) / max(len(weights), 1) if weights else 0.5
                    # 多源收录加分
                    diversity_bonus = min(len(src_list) - 1, 3) * 0.05
                    bm25 = getattr(p, '_relevance_score', 0)
                    p._final_score = bm25 * 0.7 + (src_quality + diversity_bonus) * 30 * 0.3
    ...
    def _run_search_tasks(self, tasks):
        ...
        def _execute_pool(task_list, max_workers, timeout_val, stagger_ms=50):
            if not task_list:
                return
            import random
            with ThreadPoolExecutor(max_workers=min(len(task_list), max_workers)) as executor:
                future_to_name = {}
                future_start_time = {}
                for i, (name, fn) in enumerate(task_list):
                    # 错峰启动 + 自动重试（失败后等 2s 重试一次）
                    def _staggered(fn=fn, delay=i * (stagger_ms / 1000.0) + random.random() * (stagger_ms / 1000.0)):
                        time.sleep(delay)
                        try:
                            return fn()
                        except Exception:
                ...
                for future in as_completed(future_to_name):
                    ...
                    try:
                        ...
                        source_status[name] = self._health_monitor.get_status(name)
                        timing_info[name] = {"duration": round(response_time, 2), "status": "ok"}
                        ...
                        source_status[name] = self._health_monitor.get_status(name)
                        timing_info[name] = {"duration": round(timeout_val, 2), "status": "timeout"}
                        ...
                        source_status[name] = self._health_monitor.get_status(name)
                        timing_info[name] = {"duration": round(response_time, 2), "status": "error"}
    ...
    def search_stream(self, query: str, year_from=None, year_to=0,
                      sort="relevance", max_results=50,
                      enabled_sources=None,
                      use_pubmed=True, use_openalex=True,
                      use_google_scholar=False, use_cnki=False,
                ...
                for future in as_completed(future_to_name):
                    ...
                    try:
                        ...
                        if name == "PubMed" and isinstance(result, tuple):
                            ...
                            all_papers.extend(result)
                        paper_count = len(result) if not isinstance(result, tuple) else len(result[0])
                        yield {"type": "source_done", "source": name, "count": paper_count,
                               "completed": completed, "total": total_sources,
                        ...
                        yield {"type": "source_error", "source": name,
        ...
        self._search_cache.put(query, year_from, year_to, sources_hash, unique)
        stats = self._search_cache.stats()
        print(f"[CACHE PUT stream] query='{query[:50]}' | 结果 {len(unique)} 条 | "
              f"命中率 {stats['hit_rate']} 缓存 {stats['size']}/{stats['maxsize']}")

        yield {"type": "result", "papers": unique, "errors": errors,
               "total": len(unique), "query": query,
               "query_en": query_en, "query_zh": query_zh}
    ...
    def _search_pubmed(self, query, year_from, year_to, sort, max_results,
                       journal, field, mesh_term, pub_type):
    ...
    def close(self):
        ...
        for source in [self.pubmed, self.openalex, self.google_scholar,
                       ...
                       self.semantic_scholar, self.crossref, self.arxiv,
                       self.sciencedirect, self.scopus, self.jstor,
                       self.unpaywall]:
            if source and hasattr(source, 'session'):
                try:
                    source.session.close()
